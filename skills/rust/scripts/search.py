#!/usr/bin/env python3
"""
RustSkill — CLI Search Entry Point

Usage:
    # Domain search
    python3 search.py "builder pattern newtype" --domain pattern
    python3 search.py "web api authentication" --domain crate
    python3 search.py "tokio channel pipeline" --domain concurrency

    # Stack search
    python3 search.py "middleware authentication" --stack web-axum
    python3 search.py "clap subcommands" --stack cli

    # Auto-detect domain
    python3 search.py "tokio async spawn"
...
def main():
    parser = argparse.ArgumentParser(
        description="RustSkill - Search Rust best practices, patterns, and architecture",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python3 search.py "builder pattern" --domain pattern
  python3 search.py "web framework" --domain crate
  python3 search.py "tokio async" --domain concurrency
  python3 search.py "middleware auth" --stack web-axum

"""
BM25 + Regex Hybrid Search Engine for RustSkill
Adapted from GoSkill search engine for Rust domains.
"""
...
CSV_CONFIG = {
    ...
    "unsafe": {
        "file": "unsafe-ffi.csv",
        "search_cols": ["Pattern Name", "Keywords", "Context"],
        "output_cols": ["Pattern Name", "Context", "Do", "Dont", "Code Good", "Code Bad", "Severity", "Docs URL"]
    }
}

STACK_CONFIG = {
    "web-axum": "stacks/web-axum.csv",
    "web-actix": "stacks/web-actix.csv",
    "web-rocket": "stacks/web-rocket.csv",
    "web-warp": "stacks/web-warp.csv",
    "cli": "stacks/cli.csv",
    "grpc": "stacks/grpc.csv",
    "database": "stacks/database.csv",
    "auth": "stacks/auth.csv",
    "async-runtime": "stacks/async-runtime.csv",
    "embedded": "stacks/embedded.csv",
    "wasm": "stacks/wasm.csv",
}
...
DOMAIN_KEYWORDS = {
    "pattern": ["pattern", "builder", "newtype", "typestate", "factory", "singleton", "strategy", "observer", "command", "decorator", "visitor", "state machine", "design pattern"],
    "crate": ["crate", "dependency", "cargo add", "recommend", "library", "which crate", "what package", "framework", "auth", "bcrypt", "argon2", "jwt", "oauth", "password", "serde", "tokio", "axum", "reqwest"],
    "error": ["error", "Result", "thiserror", "anyhow", "eyre", "unwrap", "expect", "panic", "error handling", "custom error", "From impl", "?"],
    "perf": ["performance", "fast", "slow", "optimize", "criterion", "benchmark", "allocation", "zero-copy", "memory", "flamegraph", "profiling", "cow", "arena"],
    "test": ["test", "mock", "assert", "mockall", "proptest", "insta", "snapshot", "fuzz", "coverage", "benchmark", "testing", "#[test]", "criterion"],
    "concurrency": ["async", "await", "tokio", "channel", "mutex", "arc", "rwlock", "spawn", "select!", "join!", "concurrent", "parallel", "rayon", "send", "sync", "atomic"],
    "trait": ["trait", "impl", "dyn", "Box<dyn", "generic", "associated type", "where clause", "bound", "object safe", "derive", "From", "Into", "AsRef", "Display", "Debug", "Iterator"],
    "arch": ["architecture", "structure", "organize", "layout", "project", "workspace", "module", "hexagonal", "layer", "crate", "directory", "clean architecture"],
    "idiom": ["idiom", "idiomatic", "best practice", "convention", "style", "clippy", "rust way", "proper way", "ergonomic", "let-else", "if let", "matches!"],
    "anti": ["anti-pattern", "bad practice", "mistake", "wrong", "avoid", "don't", "smell", "code smell", "gotcha", "common mistake", "unwrap everywhere", "clone"],
    "tooling": ["tool", "cargo", "clippy", "rustfmt", "miri", "expand", "watch", "audit", "deny", "nextest", "flamegraph", "ci", "lint"],
    "module": ["module", "mod", "pub", "use", "crate", "workspace", "Cargo.toml", "feature", "cfg", "build.rs", "visibility", "re-export"],
    "unsafe": ["unsafe", "ffi", "raw pointer", "transmute", "Pin", "extern", "bindgen", "C interop", "ManuallyDrop", "union", "no_mangle", "libc"]
}
...
def multi_domain_search(query, domains=None, max_results=3):
    ...
    if domains is None:
        domains = ["crate", "pattern", "error", "arch", "concurrency", "perf"]

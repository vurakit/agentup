"""
BM25 + Regex Hybrid Search Engine for PHPSkill
Adapted from GoSkill search engine for PHP domains.
"""
...
STACK_CONFIG = {
    ...
    "symfony": "stacks/symfony.csv",
    "codeigniter": "stacks/codeigniter.csv",
    "slim": "stacks/slim.csv",
    "api-platform": "stacks/api-platform.csv",
    "livewire": "stacks/livewire.csv",
    "database": "stacks/database.csv",
    "queue": "stacks/queue.csv",
}
...
DOMAIN_KEYWORDS = {
    "pattern": ["pattern", "singleton", "factory", "repository", "service", "middleware", "decorator", "builder", "facade", "adapter", "observer", "strategy", "dto", "value object", "specification"],
    "package": ["package", "library", "composer", "require", "recommend", "install", "guzzle", "monolog", "carbon", "flysystem", "intervention", "spatie"],
    "error": ["error", "exception", "try", "catch", "throw", "custom exception", "error handler", "set_error_handler", "set_exception_handler", "error reporting", "ErrorException"],
    "perf": ["performance", "fast", "slow", "optimize", "opcache", "preload", "jit", "cache", "memory", "n+1", "profiling", "xdebug", "blackfire"],
    "test": ["test", "phpunit", "pest", "mock", "mockery", "assert", "data provider", "feature test", "unit test", "coverage", "dusk", "browser test", "testcase"],
    "security": ["security", "sql injection", "xss", "csrf", "sanitize", "validate", "password", "hash", "bcrypt", "encryption", "auth", "jwt", "cors", "rate limit", "file upload"],
    "interface": ["interface", "abstract", "trait", "type hint", "generics", "solid", "dependency injection", "contract", "implements", "extends", "polymorphism", "composition"],
    "arch": ["architecture", "structure", "organize", "layout", "project", "mvc", "ddd", "hexagonal", "clean", "cqrs", "modular", "monolith", "microservice", "directory"],
    "idiom": ["idiom", "psr", "best practice", "convention", "style", "coding standard", "php-fig", "proper way", "php way", "modern php", "null coalescing", "match", "enum", "arrow function"],
    "anti": ["anti-pattern", "bad practice", "mistake", "wrong", "avoid", "don't", "smell", "code smell", "gotcha", "common mistake", "god class", "magic method"],
    "tooling": ["tool", "lint", "phpstan", "psalm", "rector", "php-cs-fixer", "pint", "xdebug", "composer", "artisan", "phpmd", "phpcbf"],
    "dependency": ["composer", "autoload", "psr-4", "vendor", "version", "require", "packagist", "satis", "private repository", "composer.json", "composer.lock"]
}
